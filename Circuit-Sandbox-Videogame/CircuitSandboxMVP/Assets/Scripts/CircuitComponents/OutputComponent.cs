...
public class OutputComponent : CircuitComponent
{

    public OutputComponent(Vector3Int _location, ITilemap _tilemap) : base(_location, _tilemap) {}
    ...
    public override void Connect(){
        ...
        if (Circuit.circuitComponents.TryGetValue(twoStepsLeftNeighbor, out CircuitComponent gate) && (gate is LogicGate)) {
            ins.Add(gate);
            gate.outs.Add(this);
            Debug.Log("added two steps left gate");
        }
